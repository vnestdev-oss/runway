...
export const ApplicationForm: React.FC<ApplicationFormProps> = ({ currentStep, setCurrentStep }) => {
  ...
  if (submitStatus === "success") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6 px-8 py-12">
        <div className="relative rounded-md border border-[#545454] bg-[#060606] p-10 max-w-2xl">
  ...
  if (submitStatus === "error") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6 px-8 py-12">
        <div className="rounded-md border border-[#545454] bg-[#060606] p-10 max-w-2xl">
          <div className="flex items-center justify-center w-20 h-20 mx-auto rounded-full bg-red-900 mb-4">
            <svg
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Submission Failed</h2>
          <p className="text-lg text-gray-400 mb-4">{errorMessage}</p>
          <button
            onClick={handleRetry}
            className="px-6 py-3 rounded-md bg-purple-600 text-white font-semibold hover:bg-purple-700 transition duration-200"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    <div className="flex-1 bg-[#060606] relative">
      <div className="max-w-6xl mx-auto px-16 py-20 pb-32">
        {/* Header with Help Link */}
        {currentStep !== 1 && (
          <div className="flex justify-between items-start mb-12">
            <div>
              <h1 className="text-4xl font-bold text-white mb-3">{getStepTitle()}</h1>
              <p className="text-base text-gray-400">{getStepDescription()}</p>
            </div>
          </div>
        )}
          ...
          {currentStep === 1 && (
            <SlideShow
              slides={[
                ...
                <div key="intro" className="p-8 space-y-8 flex flex-col items-center justify-center min-h-[calc(100vh-400px)]">
                  <div className="text-center space-y-2">
                    <h2 className="text-5xl font-bold text-white">Runway</h2>
                ...
                // Slide 2: Why Runway
                <div key="why" className="p-8 space-y-6">
                  <h2 className="text-3xl font-bold text-white">Why Runway?</h2>
                  ...
                  <ol className="space-y-3 text-gray-300 list-decimal ml-6 marker:text-purple-400">
                    <li className="pl-3">
                ...
                <div key="who" className="p-8 space-y-6">
                  <h2 className="text-3xl font-bold text-white">Who Can Apply?</h2>
                  <ol className="space-y-3 text-gray-300 list-decimal ml-6 marker:text-purple-400">
                    <li className="pl-3">
                ...
                <div key="need" className="p-8 space-y-6">
                  <h2 className="text-3xl font-bold text-white">What You Need to Apply</h2>
                  <p className="text-base text-gray-300 leading-relaxed">
                ...
                <div key="how" className="p-8 space-y-6">
                  <h2 className="text-3xl font-bold text-white">How Runway Works</h2>
                ...
                // Slide 6: Tracks
                <div key="tracks" className="p-8 space-y-6">
                  <h2 className="text-3xl font-bold text-white">Tracks Explained</h2>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="rounded-md bg-[#060606] p-6 border border-[#545454]">
                      <h3 className="text-xl font-semibold text-purple-400 mb-2">Incubation</h3>
                      <p className="text-base text-gray-400 mb-3">For high-potential ideas ready for long-term support:</p>
                      <ol className="space-y-2 text-sm text-gray-300 list-decimal ml-6 marker:text-purple-400">
                        <li className="pl-3">
                    ...
                    <div className="rounded-md bg-[#060606] p-6 border border-[#545454]">
                      <h3 className="text-xl font-semibold text-purple-400 mb-2">SSV (Student Startup Venture)</h3>
                      <p className="text-base text-gray-400 mb-3">For early-stage ideas requiring resources:</p>
                      <ol className="space-y-2 text-sm text-gray-300 list-decimal ml-6 marker:text-purple-400">
                        <li className="pl-3">
                ...
                // Slide 8: FAQ
                <div key="faq" className="p-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="rounded-md bg-[#060606] border border-[#545454] overflow-hidden">
                      ...
                      >
                        <h3 className="text-lg font-semibold text-white">Do I need a working prototype to apply?</h3>
                        <ChevronDown className={`w-5 h-5 text-purple-400 transition-transform ${openFaqIndex === 0 ? 'rotate-180' : ''}`} />
                      </button>
                      {openFaqIndex === 0 && (
                    ...
                    <div className="rounded-md bg-[#060606] border border-[#545454] overflow-hidden">
                      <button
                        ...
                        className="w-full p-5 text-left flex items-center justify-between transition-colors cursor-pointer"
                      >
                        <h3 className="text-lg font-semibold text-white">Can I apply as an individual?</h3>
                        <ChevronDown className={`w-5 h-5 text-purple-400 transition-transform ${openFaqIndex === 1 ? 'rotate-180' : ''}`} />
                      </button>
                      {openFaqIndex === 1 && (
                        <div className="px-5 pb-5">
                          <p className="text-sm text-gray-400">
                    ...
                    <div className="rounded-md bg-[#060606] border border-[#545454] overflow-hidden">
                      <button
                        ...
                        className="w-full p-5 text-left flex items-center justify-between transition-colors cursor-pointer"
                      >
                        <h3 className="text-lg font-semibold text-white">Is having a faculty mentor mandatory?</h3>
                        <ChevronDown className={`w-5 h-5 text-purple-400 transition-transform ${openFaqIndex === 2 ? 'rotate-180' : ''}`} />
                      </button>
                      {openFaqIndex === 2 && (
                        <div className="px-5 pb-5">
                          <p className="text-sm text-gray-400">
                ...
                <div key="ready" className="p-8 space-y-8 flex flex-col items-center justify-center min-h-[400px]">
            ...
            <div className="fixed bottom-0 left-[420px] right-0 bg-[#060606] border-t border-[#545454] p-6">
              <div className="flex items-center justify-between max-w-4xl mx-auto">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-3 rounded-lg transition-all bg-transparent text-white hover:bg-white/10 border border-white"
                >
                ...
                {currentStep < STEPS.length ? (
                  <button
                    type="button"
                    onClick={handleNext}
                    className="flex items-center gap-2 px-6 py-3 rounded-lg transition-all bg-purple-600 text-white hover:bg-purple-700"
                  >
                    <span>Next</span>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 rounded-lg transition-all bg-green-600 text-white hover:bg-green-700 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
